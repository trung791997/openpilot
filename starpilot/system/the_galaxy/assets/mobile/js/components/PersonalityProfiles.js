...
// not consume LongitudinalPersonalityProfiles, so the profile editor stays off and the legacy
// controls render instead. Flip only together with a planner port that reads the profiles.
export const PERSONALITY_PROFILES_ENABLED = false
