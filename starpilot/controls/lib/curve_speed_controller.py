...
class CurveSpeedController:
  ...
  def log_data(self, v_ego, sm, manual_speed_control=None):
    # manual_speed_control lets the caller supply an ICBM-aware state; see starpilot_vcruise.
    if manual_speed_control is None:
